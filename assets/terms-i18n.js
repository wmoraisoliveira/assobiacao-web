...
(function () {
  ...
  var TT = {
    ...
    'pt-BR': {
      ...
      s12num: 'Seção 12', s12title: 'Compras no App',
      s12body: '<p>O Modo Treino pode ser desbloqueado por meio de <strong>compra avulsa por torneio</strong> dentro do aplicativo. É uma compra única, sem renovação automática.</p><p>O pagamento é cobrado via Apple ID (iOS) ou Google Play (Android). Não realizamos reembolsos, salvo quando exigido por lei.</p><p><strong>Acesso Antecipado:</strong> Usuários que tenham adquirido o acesso avulso para um torneio podem treinar e enviar vídeos oficiais antes do início oficial ("em breve"). Vídeos enviados durante o período de acesso antecipado são recebidos pelo sistema, mas só entram em revisão e ficam disponíveis no ranking após o início oficial do torneio.</p><p>Os torneios do Assobiacão não são patrocinados, administrados nem associados à Apple Inc. de nenhuma forma. A Apple Inc. não tem qualquer responsabilidade sobre os prêmios, regras ou resultados dos torneios.</p>',
    ...
    en: {
      ...
      s12body: '<p>Training Mode can be unlocked through a <strong>one-time per-tournament purchase</strong> inside the app. There is no subscription or automatic renewal.</p><p>Payment is billed through your Apple ID (iOS) or Google Play account (Android). We do not offer refunds except where required by law.</p><p><strong>Early Access:</strong> Users who purchase per-tournament access may train and submit official videos before the tournament officially starts ("coming soon"). Videos submitted during the early access period are received by the system but only enter review and appear in the ranking once the tournament officially starts.</p><p>Assobiacão tournaments are not sponsored, administered, or associated with Apple Inc. in any way. Apple Inc. bears no responsibility for tournament prizes, rules, or results.</p>',
    ...
    es: {
      ...
      s12body: '<p>El Modo Entrenamiento puede desbloquearse mediante una <strong>compra individual por torneo</strong> dentro de la aplicación. Es una compra única, sin suscripción ni renovación automática.</p><p>El pago se cobra a través de tu Apple ID (iOS) o cuenta de Google Play (Android). No realizamos reembolsos, salvo cuando lo exija la ley.</p><p><strong>Acceso Anticipado:</strong> Los usuarios que hayan adquirido acceso individual por torneo pueden entrenar y enviar videos oficiales antes del inicio oficial del torneo ("próximamente"). Los videos enviados durante el acceso anticipado son recibidos por el sistema, pero solo entran en revisión y aparecen en el ranking una vez que el torneo inicia oficialmente.</p><p>Los torneos de Assobiacão no están patrocinados, administrados ni asociados a Apple Inc. de ninguna forma. Apple Inc. no tiene ninguna responsabilidad sobre los premios, las reglas ni los resultados de los torneos.</p>',
    ...
    fr: {
      ...
      s12body: '<p>Le Mode Entraînement peut être débloqué via un <strong>achat ponctuel par tournoi</strong> dans l\'application. Il n\'y a pas d\'abonnement ni de renouvellement automatique.</p><p>Le paiement est débité via votre identifiant Apple (iOS) ou votre compte Google Play (Android). Nous n\'effectuons pas de remboursements, sauf obligation légale.</p><p><strong>Accès Anticipé :</strong> Les utilisateurs ayant effectué un achat ponctuel pour un tournoi peuvent s\'entraîner et soumettre des vidéos officielles avant le début officiel du tournoi ("bientôt disponible"). Les vidéos soumises pendant la période d\'accès anticipé sont reçues par le système, mais n\'entrent en révision et n\'apparaissent dans le classement qu\'une fois le tournoi officiellement démarré.</p><p>Les tournois d\'Assobiacão ne sont pas parrainés, administrés ni associés à Apple Inc. d\'aucune façon. Apple Inc. n\'assume aucune responsabilité quant aux prix, règles ou résultats des tournois.</p>',
