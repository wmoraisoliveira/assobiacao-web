...
(function () {
  ...
  var TT = {
    ...
    'pt-BR': {
      ...
      updated: 'Última atualização: 29 de maio de 2025',
    ...
    en: {
      ...
      updated: 'Last updated: May 29, 2025',
    ...
    es: {
      ...
      updated: 'Última actualización: 29 de mayo de 2025',
      ...
      s3body: '<p>Para usar Assobiacão debes:</p><ul><li>Tener <strong>al menos 16 años de edad</strong>;</li><li>Proporcionar información de registro verdadera y actualizada;</li><li>Mantener la confidencialidad de tus credenciales de acceso;</li><li>Ser responsable de todas las actividades realizadas con tu cuenta.</li></ul><p>Los usuarios de 16 a 17 años declaran tener autorización de padres o tutores legales para usar la app y participar en torneos, incluido el cobro de premios. Los menores de 16 años no deben utilizar esta aplicación.</p><p>Cada cuenta es <strong>estrictamente personal e intransferible</strong>. Solo el titular de la cuenta puede usarla. Aceptas notificar inmediatamente a Assobiacão sobre cualquier uso no autorizado de tu cuenta en <strong>contato@assobiacao.app</strong>.</p>',
      ...
      s6body: '<p><strong>Funcionamiento de los torneos</strong></p><ul><li>Cada torneo tiene tema, plazo de inscripción y criterios propios, mostrados dentro de la App;</li><li>La puntuación final (<strong>finalScore</strong>) es asignada automáticamente por inteligencia artificial según criterios técnicos: melodía, ritmo, afinación y claridad;</li><li>Solo los envíos oficiales se consideran para el ranking final — las grabaciones en modo entrenamiento no cuentan;</li><li>En caso de empate, gana el participante que envió su grabación antes (criterio de desempate: fecha y hora de envío).</li></ul><p><strong>Premios — 1.°, 2.° y 3.° lugar</strong></p><ul><li>Los valores de los premios para cada clasificación se muestran en la página del torneo dentro de la App antes de la inscripción;</li><li>Al final del torneo, los tres primeros clasificados son notificados por la App y tienen <strong>15 días naturales</strong> a partir del cierre para reclamar el premio;</li><li>Los premios no reclamados en ese plazo expiran automáticamente y no podrán solicitarse con posterioridad.</li></ul><p><strong>Pago vía PIX y CPF</strong></p><ul><li>Los premios se pagan <strong>exclusivamente vía PIX</strong>, usando el <strong>CPF registrado en el perfil</strong> del usuario como clave PIX;</li><li>El usuario debe registrar su CPF en el perfil antes de reclamar el premio. El CPF es validado automáticamente por el sistema;</li><li>Una vez registrado, el CPF <strong>solo podrá modificarse contactando al soporte</strong> (<a href="mailto:contato@assobiacao.app">contato@assobiacao.app</a>) — esta restricción existe para prevenir fraudes y proteger a los ganadores legítimos;</li><li>El pago es realizado por el equipo Assobiacão en hasta 10 días hábiles tras la aprobación del retiro.</li></ul><p>Las decisiones de la IA sobre la puntuación son definitivas, salvo error técnico comprobado. Las reclamaciones deben enviarse a <strong>contato@assobiacao.app</strong> en un plazo de 48 horas tras la publicación de los resultados. Assobiacão puede cancelar o aplazar torneos por razones técnicas u operativas, notificando a los participantes con antelación. En caso de cancelación, los premios ya aprobados se pagarán normalmente.</p>',

      s7num: 'Sección 7', s7title: 'Privacidad',
      s7body: '<p>Assobiacão respeta tu privacidad y cumple con la Ley General de Protección de Datos de Brasil (Lei nº 13.709/2018 — LGPD). Tus datos personales son recopilados y tratados para:</p><ul><li>Crear y gestionar tu cuenta;</li><li>Procesar tu participación en torneos;</li><li>Realizar el pago de premios vía PIX — para ello recopilamos y almacenamos el <strong>CPF</strong> del usuario, que sirve como clave PIX e instrumento de verificación de identidad del ganador;</li><li>Mejorar el funcionamiento de la App y de la IA de puntuación;</li><li>Enviar comunicaciones sobre torneos y funcionalidades (con posibilidad de cancelación en cualquier momento).</li></ul><p>Puedes ejercer tus derechos como titular de datos (acceso, corrección, eliminación, portabilidad) contactando a <strong>contato@assobiacao.app</strong>. No compartimos tus datos personales con terceros con fines comerciales sin tu consentimiento.</p>',
    ...
    fr: {
      ...
      updated: 'Dernière mise à jour : 29 mai 2025',
      ...
      s3body: '<p>Pour utiliser Assobiacão, vous devez :</p><ul><li>Avoir <strong>au moins 16 ans</strong> ;</li><li>Fournir des informations d\'inscription véridiques et à jour ;</li><li>Préserver la confidentialité de vos identifiants d\'accès ;</li><li>Être responsable de toutes les activités effectuées avec votre compte.</li></ul><p>Les utilisateurs âgés de 16 à 17 ans déclarent avoir l\'autorisation d\'un parent ou d\'un tuteur légal pour utiliser l\'app et participer aux tournois, y compris pour encaisser des prix. Les moins de 16 ans ne doivent pas utiliser cette application.</p><p>Chaque compte est <strong>strictement personnel et non cessible</strong>. Seul le titulaire du compte peut l\'utiliser. Vous acceptez de notifier immédiatement Assobiacão de toute utilisation non autorisée de votre compte à <strong>contato@assobiacao.app</strong>.</p>',
