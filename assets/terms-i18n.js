...
(function () {
  ...
  var TT = {
    ...
    'pt-BR': {
      ...
      s12num: 'Seção 12', s12title: 'Assinaturas e Compras no App',
      s12body: '<p>O Modo Treino pode ser desbloqueado por meio de compras dentro do aplicativo: <strong>assinatura mensal com renovação automática</strong> ou <strong>compra avulsa por torneio</strong>.</p><p>O pagamento é cobrado via Apple ID (iOS) ou Google Play (Android). A assinatura mensal renova automaticamente ao final de cada período, a menos que seja cancelada com pelo menos 24 horas de antecedência. O cancelamento pode ser feito a qualquer momento nas configurações da sua loja de aplicativos. Não realizamos reembolsos parciais por período não utilizado, salvo quando exigido por lei.</p><p><strong>Acesso Antecipado:</strong> Usuários com assinatura mensal ativa ou que tenham adquirido o acesso avulso podem treinar em torneios ainda não iniciados ("em breve"). Vídeos enviados como oficiais durante o período de acesso antecipado são recebidos pelo sistema, mas só entram em revisão e ficam disponíveis no ranking após o início oficial do torneio.</p><p>Os torneios do Assobiacão não são patrocinados, administrados nem associados à Apple Inc. de nenhuma forma. A Apple Inc. não tem qualquer responsabilidade sobre os prêmios, regras ou resultados dos torneios.</p>',
    ...
    en: {
      ...
      s12num: 'Section 12', s12title: 'Subscriptions and In-App Purchases',
      s12body: '<p>Training Mode can be unlocked through in-app purchases: a <strong>monthly auto-renewable subscription</strong> or a <strong>one-time per-tournament purchase</strong>.</p><p>Payment is billed through your Apple ID (iOS) or Google Play account (Android). The monthly subscription renews automatically at the end of each period unless cancelled at least 24 hours before renewal. You may cancel at any time in your app store settings. We do not offer partial refunds for unused periods, except where required by law.</p><p><strong>Early Access:</strong> Users with an active monthly subscription or a per-tournament purchase may train for upcoming (not-yet-started) tournaments. Videos submitted as official during the early access period are received by the system but only enter review and appear in the ranking once the tournament officially starts.</p><p>Assobiacão tournaments are not sponsored, administered, or associated with Apple Inc. in any way. Apple Inc. bears no responsibility for tournament prizes, rules, or results.</p>',
    ...
    es: {
      ...
      s12num: 'Sección 12', s12title: 'Suscripciones y Compras en la App',
      s12body: '<p>El Modo Entrenamiento puede desbloquearse mediante compras dentro de la aplicación: una <strong>suscripción mensual de renovación automática</strong> o una <strong>compra individual por torneo</strong>.</p><p>El pago se cobra a través de tu Apple ID (iOS) o cuenta de Google Play (Android). La suscripción mensual se renueva automáticamente al final de cada período, a menos que se cancele con al menos 24 horas de antelación. Puedes cancelar en cualquier momento en los ajustes de tu tienda de aplicaciones. No realizamos reembolsos parciales por el período no utilizado, salvo cuando lo exija la ley.</p><p><strong>Acceso Anticipado:</strong> Los usuarios con suscripción mensual activa o compra individual por torneo pueden entrenar en torneos aún no iniciados. Los videos enviados como oficiales durante el acceso anticipado son recibidos por el sistema, pero solo entran en revisión y aparecen en el ranking una vez que el torneo inicia oficialmente.</p><p>Los torneos de Assobiacão no están patrocinados, administrados ni asociados a Apple Inc. de ninguna forma. Apple Inc. no tiene ninguna responsabilidad sobre los premios, las reglas ni los resultados de los torneos.</p>',
    ...
    fr: {
      ...
      s12num: 'Article 12', s12title: 'Abonnements et Achats in-app',
      s12body: '<p>Le Mode Entraînement peut être débloqué via des achats intégrés : un <strong>abonnement mensuel à renouvellement automatique</strong> ou un <strong>achat ponctuel par tournoi</strong>.</p><p>Le paiement est débité via votre identifiant Apple (iOS) ou votre compte Google Play (Android). L\'abonnement mensuel se renouvelle automatiquement à la fin de chaque période, sauf annulation au moins 24 heures avant le renouvellement. Vous pouvez annuler à tout moment dans les paramètres de votre boutique d\'applications. Nous n\'effectuons pas de remboursements partiels pour la période non utilisée, sauf obligation légale.</p><p><strong>Accès Anticipé :</strong> Les utilisateurs avec un abonnement mensuel actif ou un achat ponctuel par tournoi peuvent s\'entraîner pour des tournois pas encore commencés. Les vidéos soumises comme officielles pendant la période d\'accès anticipé sont reçues par le système, mais n\'entrent en révision et n\'apparaissent dans le classement qu\'une fois le tournoi officiellement démarré.</p><p>Les tournois d\'Assobiacão ne sont pas parrainés, administrés ni associés à Apple Inc. d\'aucune façon. Apple Inc. n\'assume aucune responsabilité quant aux prix, règles ou résultats des tournois.</p>',
