...
(function () {
  ...
  var TP = {
    ...
    en: {
      ...
      s5body: '<p>Your data may only be shared in the following situations:</p><ul><li><strong>Infrastructure providers:</strong> we use Firebase (Google LLC) for authentication, data storage and video hosting. Data is processed on Google\'s servers in accordance with their privacy policies;</li><li><strong>In-app purchase processing:</strong> we use RevenueCat Inc. to process in-app purchases. RevenueCat receives transaction identifiers, but not your full personal data;</li><li><strong>Legal requirement:</strong> we may disclose data when required by law, court order or competent government authority.</li></ul><p>No personal data is transferred to countries without an adequate level of protection without the safeguards required by applicable law.</p>',
